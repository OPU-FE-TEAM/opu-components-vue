...
var _default = {
  ...
  computed: {
    ...
    submitOpt: function submitOpt() {
      var option = this.option;
      return option.proxyConfig && option.proxyConfig.submit ? option.proxyConfig.submit : {};
    },
  ...
  methods: {
    ...
    fetchColumns: function fetchColumns() {
      ...
      var getOpt = this.getOpt;
      var json = (0, _objectSpread2.default)({}, getOpt.param);
      getOpt.api(json).then(function (res) {
        var dataField = getOpt.dataField ? getOpt.dataField : "data";

        var data = _utils.default.getObjData(dataField, res);
      ...
      this.$nextTick(function () {
        ...
        _this2.sortable2 = _sortablejs.default.create(xTable.$el.querySelector(".columns-table .body--wrapper>.vxe-table--body tbody"), {
          ...
          onEnd: function onEnd(_ref) {
            ...
            var tableTreeData = _this2.columns;
    ...
    onSubmit: function onSubmit() {
      ...
      var submitOpt = this.submitOpt,
          getOpt = this.getOpt;
      var data = this.getData();

      if (submitOpt.api) {
        var json = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, getOpt.param), {}, {
          data: data.tableData
        });
        var callbackRes = submitOpt.before && submitOpt.before(json);
        ...
        submitOpt.api(json).then(function (res) {
          _this3.visible = false;
          submitOpt.after && submitOpt.after(res);

          _this3.$emit("submit", res);
        });
      }
    }
  },

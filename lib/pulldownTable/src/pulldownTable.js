...
function renderInput(h, _vm) {
  var onInputFocus = _vm.onInputFocus,
      ...
      onInputKeyUp = _vm.onInputKeyUp; // const onChange = utils.debounce(onInputChange, 200);
...
var _default = {
  ...
  created: function created() {
    ...
    this.selectValue = this.value; // this.inputChangeValue = this.value;
  },
  methods: {
    ...
    onPulldownHide: function onPulldownHide() {
      ...
      if (this.allowInputValue) {
        this.selectValue = this.inputChangeValue; // console.log("---", this.selectValue, this.inputChangeValue);

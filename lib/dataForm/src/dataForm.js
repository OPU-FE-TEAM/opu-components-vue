...
var baseComponents = ["a-date-picker"];
...
var _default2 = {
  ...
  data: function data() {
    return {
      ...
      // loading: false,
      // 支持回车活动焦点的组件
      focusItemTypes: ["a-input", "a-password", "a-input-number", "a-select", "a-date-picker", "a-month-picker", "a-week-picker", "a-range-picker", "a-cascader", "a-tree-select", "a-textarea"]
    };
  },
  computed: {
    // 回车跳转下一个表单项获得焦点的字段列表

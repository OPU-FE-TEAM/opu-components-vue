...
require("ant-design-vue/lib/upload/style/css");

var _button = _interopRequireDefault(require("ant-design-vue/lib/button"));

require("ant-design-vue/lib/button/style/css");

var _message = _interopRequireDefault(require("ant-design-vue/lib/message"));
...
var _default = {
  name: 'DataForm',
  components: (_components = {}, (0, _defineProperty2.default)(_components, _upload.default.name, _upload.default), (0, _defineProperty2.default)(_components, _button.default.name, _button.default), _components),
  props: {
    name: String,
  ...
  methods: {
    ...
    hasAccept: function hasAccept(info, isMessage) {
      if (info.size > this.maxSize) {
        ...
        if (isMessage) {
          _message.default.error("\u9644\u4EF6\u9650\u5236\u5927\u5C0F\u4E3A\uFF1A".concat(kb, "KB"));
        }

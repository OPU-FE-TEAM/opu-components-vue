...
var Cascader = {
  ...
  methods: {
    ...
    highlightKeyword: function highlightKeyword(str, keyword, prefixCls) {
      ...
      return str.split(keyword).map(function(node, index) {
        return index === 0
          ? node
          : [
              h("span", { class: prefixCls + "-menu-item-keyword" }, [keyword]),
              node
            ];
      });
    },
      ...
      return path.map(function(option, index) {
        ...
        var node =
          label.indexOf(inputValue) > -1
            ? _this2.highlightKeyword(label, inputValue, prefixCls)
            : label;
    ...
    getLabel: function getLabel() {
      ...
      var displayRender =
        this.displayRender ||
        $scopedSlots.displayRender ||
        defaultDisplayRender;
      var value = this.sValue;
      var unwrappedValue = Array.isArray(value[0]) ? value[0] : value;
      var selectedOptions = arrayTreeFilter(
        options,
        function(o, level) {
    ...
    generateFilteredOptions: function generateFilteredOptions(
      prefixCls,
      renderEmpty
    ) {
      var _ref5;
      ...
      var _showSearch$filter = showSearch.filter,
        filter =
          _showSearch$filter === undefined
            ? defaultFilterOption
            : _showSearch$filter,
        _showSearch$sort = showSearch.sort,
        sort =
          _showSearch$sort === undefined
            ? defaultSortFilteredOption
            : _showSearch$sort,
        _showSearch$limit = showSearch.limit,
        limit =
          _showSearch$limit === undefined ? defaultLimit : _showSearch$limit;

      var render =
        showSearch.render ||
        $scopedSlots.showSearchRender ||
        this.defaultRenderFilteredOption;
      var _$data = this.$data,
        _$data$flattenOptions = _$data.flattenOptions,
        flattenOptions =
          _$data$flattenOptions === undefined ? [] : _$data$flattenOptions,
      ...
      return [
        ...
        _defineProperty(
          _ref5,
          names.label,
          notFoundContent || renderEmpty(h, "Cascader")
        ),
        _defineProperty(_ref5, names.value, "ANT_CASCADER_NOT_FOUND"),
        _defineProperty(_ref5, "disabled", true),
        _ref5)
      ];
    },
    ...
    getVisible() {
      return hasProp(this, "popupVisible");
    }
  },
  ...
  render() {
    ...
    var sizeCls = classNames(
      ((_classNames = {}),
      _defineProperty(_classNames, inputPrefixCls + "-lg", size === "large"),
      _defineProperty(_classNames, inputPrefixCls + "-sm", size === "small"),
      _classNames)
    );
    var clearIcon =
    ...
    var arrowCls = classNames(
      ((_classNames2 = {}),
      _defineProperty(_classNames2, prefixCls + "-picker-arrow", true),
      _defineProperty(
        _classNames2,
        prefixCls + "-picker-arrow-expand",
        sPopupVisible
      ),
      _classNames2)
    );
    var pickerCls = classNames(
      ...
      _defineProperty(
        _classNames3,
        prefixCls + "-picker-with-value",
        inputValue
      ),
      _defineProperty(_classNames3, prefixCls + "-picker-disabled", disabled),
      _defineProperty(_classNames3, prefixCls + "-picker-" + size, !!size),
      _defineProperty(
        _classNames3,
        prefixCls + "-picker-show-search",
        !!showSearch
      ),
      _defineProperty(
        _classNames3,
    ...
    var tempInputProps = omit(otherProps, [
      "options",
      "popupPlacement",
      "transitionName",
      "displayRender",
    ...
    if (options && options.length > 0) {
      ...
      options = [
        ...
        _defineProperty(_ref6, names.value, "ANT_CASCADER_NOT_FOUND"),
        _defineProperty(_ref6, "disabled", true),
        _ref6)
      ];
    }
    ...
    var inputIcon =
      (suffixIcon &&
        (isValidElement(suffixIcon)
          ...
          : h("span", { class: prefixCls + "-picker-arrow" }, [suffixIcon]))) ||
      h(Icon, {
        attrs: { type: "down" },
        class: arrowCls
      });
    var input = children.length
      ? children
      : h("span", { class: pickerCls, style: getStyle(this), ref: "picker" }, [
          showSearch
            ? h("span", { class: prefixCls + "-picker-label" }, [
                this.getLabel()
              ])
            : null,
          h(Input, inputProps),
    ...
    return h(VcCascader, cascaderProps, [input]);
  }
};
